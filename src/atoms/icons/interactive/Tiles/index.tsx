...
const tileClass = rule({
  ...
  trs:
    'background-color .15s,top .15s cubic-bezier(0.175, 0.885, 0.32, 1.275), left .15s cubic-bezier(0.175, 0.885, 0.32, 1.275)',
  // op: .4,
...
const IconTiles: React.SFC<Props> = ({size, ...rest}) => {
  let style = null;
